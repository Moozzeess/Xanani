            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden transform transition-all scale-100 animate-in zoom-in-95 duration-300 border border-white/20">
                ...
                <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-8 flex flex-col items-center text-white relative">
                    <div className="absolute top-0 right-0 p-4 opacity-10">
                        <img src="/bus_parada.svg" style={{ width: '120px', height: '120px' }} className="brightness-0 invert" alt="" />
                    </div>
                    ...
                    <div className="w-20 h-20 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center mb-4 ring-8 ring-white/10 p-4">
                        <img src="/bus_parada.svg" className="w-full h-full brightness-0 invert" alt="Ubicación" />
                    </div>
