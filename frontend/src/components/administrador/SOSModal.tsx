          ...
          <div className="flex items-center gap-5 mb-8">
            ...
            <div>
              ...
              <p className="text-red-600 font-bold mt-1 flex items-center gap-2 text-sm">
                <img src="/bus_parada.svg" className="w-5 h-5" style={{ filter: 'invert(27%) sepia(91%) saturate(2352%) hue-rotate(346deg) brightness(104%) contrast(97%)' }} alt="Ubicación" /> {incidencia?.descripcion || 'Solicitud de ayuda inmediata'}
              </p>
