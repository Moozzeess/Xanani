...
import { LogOut, LayoutDashboard, Cpu, Server, Users } from "lucide-react";
...
import GestionConductores from "./GestionConductores"; // Gestión de conductores
      ...
      <div className="bg-slate-800 px-6 shrink-0 border-b border-slate-700">
        <div className="flex gap-4">
          ...
          <button
            ...
            className={`px-4 py-3 text-sm font-bold flex items-center gap-2 border-b-2 transition-colors ${activeTab === 'conductores'
                ? 'border-blue-500 text-blue-400'
                : 'border-transparent text-slate-400 hover:text-slate-200'
              }`}
          >
            <Users size={18} /> Gestión de Conductores
          </button>
      ...
      <main className="flex-1 overflow-auto p-6 relative">
        {activeTab === 'dashboard' && (
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            ...
            <p className="text-slate-500 mb-8">Bienvenido al Panel de Control de Xanani.</p>
